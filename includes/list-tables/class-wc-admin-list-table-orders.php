...
class WC_Admin_List_Table_Orders extends WC_Admin_List_Table {
	...
	protected function render_blank_state() {
		...
		echo '<a class="woocommerce-BlankState-cta button-primary button" target="_blank" href="https://classiccommerce.org/usage-and-maintenance/managing-orders/">' . esc_html__( 'Learn more about orders', 'classic-commerce' ) . '</a>';
		echo '</div>';
