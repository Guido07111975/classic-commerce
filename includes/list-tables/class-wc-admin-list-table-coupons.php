...
class WC_Admin_List_Table_Coupons extends WC_Admin_List_Table {
	...
	protected function render_blank_state() {
		...
		echo '<a class="woocommerce-BlankState-cta button" target="_blank" href="https://classiccommerce.org/docs/installation-and-setup/coupons/">' . esc_html__( 'Learn more about coupons', 'classic-commerce' ) . '</a>';
		echo '</div>';
	}
