...
<div id="inventory_product_data" class="panel woocommerce_options_panel hidden">
    ...
    <div class="inline notice woocommerce-message show_if_variable">
		<p>
			<?php echo esc_html_e( 'Settings below apply to all variations without manual stock management enabled.', 'classic-commerce' ); ?> <a target="_blank" href="https://classiccommerce.org/docs/installation-and-setup/variable-products/"><?php esc_html_e( 'Learn more', 'classic-commerce' ); ?></a>
		</p>
	</div>
