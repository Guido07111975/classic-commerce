		...
		$settings =
			array(
				...
				'force_ssl_checkout'   => array(
					...
					'desc_tip'        => sprintf( __( 'Force SSL (HTTPS) on the checkout pages (<a href="%s" target="_blank">an SSL Certificate is required</a>).', 'classic-commerce' ), 'https://classiccommerce.org/docs/installation-and-setup/ssl-and-https/' ),
				),
