...
class WC_Settings_Emails extends WC_Settings_Page {
	...
	protected function get_settings_for_default_section() {
		...
		/* translators: %1$s: Link to WP Mail Logging plugin, %2$s: Link to Email FAQ support page. */
			...
			'https://classiccommerce.org/docs/installation-and-setup/email-settings/'
		);
		$settings =
			array(
				array(
				...
				array(
					...
					'desc'     => sprintf( __( 'The base color for Classic Commerce email templates. Default %s.', 'classic-commerce' ), '<code>#376e71</code>' ),
