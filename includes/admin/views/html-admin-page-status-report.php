...
<div class="updated woocommerce-message inline">
	...
	<p class="submit">
		...
		<a class="button-secondary docs" href="https://classiccommerce.org/docs/installation-and-setup/status-report/" target="_blank">
		...
		<tr>
			...
			<td>
				...
				<?php else : ?>
					...
					echo wp_kses_post( sprintf( __( 'Your store is not using HTTPS. <a href="%s" target="_blank">Learn more about HTTPS and SSL Certificates</a>.', 'classic-commerce' ), 'https://classiccommerce.org/docs/installation-and-setup/ssl-and-https/' ) );
					?>
					</mark>
				<?php endif; ?>
			</td>
        ...
        <?php if ( true === $theme['has_outdated_templates'] ) : ?>
			<tr>
				...
				<td>
					...
					<a href="https://classiccommerce.org/docs/usage-and-maintenance/fix-outdated-templates/" target="_blank">
