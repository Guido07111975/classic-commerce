...
class WC_Admin_Setup_Wizard {
	...
	public function wc_setup_ready() {
		...
		$docs_url     = 'https://classiccommerce.org/docs/installation-and-setup/';
		$help_text    = sprintf(
			/* translators: %1$s: link to docs */
			__( 'Visit classiccommerce.org to learn more about <a href="%1$s" target="_blank">getting started</a>.', 'classic-commerce' ),
			$docs_url
		);
		?>
