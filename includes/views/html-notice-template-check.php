...
<div id="message" class="updated woocommerce-message">
	...
	<p class="submit">
		<a class="button-primary" href="https://classiccommerce.org/docs/installation-and-setup/template-structure/" target="_blank"><?php esc_html_e( 'Learn more about templates', 'classic-commerce' ); ?></a>
