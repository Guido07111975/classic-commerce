...
<div id="message" class="updated woocommerce-message">
	...
	<p class="submit">
		...
		<?php endif; ?>
		<a class="button-secondary" href="https://classiccommerce.org/docs/installation-and-setup/shipping/"><?php esc_html_e( 'Learn more about shipping zones', 'classic-commerce' ); ?></a>
	</p>
</div>
